...
export class StockTableModel extends DOMWidgetModel {
    defaults() {
        return {
            ...super.defaults(),
            _model_name: StockTableModel.model_name,
            _model_module: StockTableModel.model_module,
            _model_module_version: StockTableModel.model_module_version,
            _view_name: StockTableModel.view_name,
            _view_module: StockTableModel.view_module,
            _view_module_version: StockTableModel.view_module_version,
            value: 'Hello World',
        };
    }
    ...
    static model_name = 'StockTableModel';
    static model_module = MODULE_NAME;
    static model_module_version = MODULE_VERSION;
    static view_name = 'StockTableView'; // Set to null if no view
...
export class StockTableView extends DOMWidgetView {
    render() {
